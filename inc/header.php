                    ...
                    <div class="container-fluid fst-italic">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="shop_category.php">Cửa Hàng</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <form class="d-flex" role="search" action="search.php" method="POST">
                                ...
                                <button class="btn btn-outline-success" name="search_product" type="submit">Search</button>
                            </form>
                        </div>
                    </div>
                </nav>         
