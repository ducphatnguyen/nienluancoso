                        ...
                        <tr>
                            ...
                            <td>
                                <form action="" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <input class="form-control"min="1" max="<?php echo $result['sl_conlai'] ?>" name="quantity" value="<?php echo $result['quantity'] ?>" type="number" class="w-50">
                                        </div>
                                        <div class="col-6">
                            ...
                            <td><a class="btn btn-danger" onclick = "return confirm('Are you sure?')" href="?cartid=<?php echo $result['cartId'] ?>">Xóa</a></td>
                        </tr>
                    </tbody>  
                    <?php
                        $subtotal += $total; 	
