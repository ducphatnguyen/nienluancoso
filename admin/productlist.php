		...
		<table id="example" class="table table-bordered align-middle text-center table-striped table-responsive">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a class="btn btn-warning" href="productedit.php?productid=<?php echo $result['productId'] ?>">Chỉnh sửa</a>
						<a class="btn btn-danger" href="?productid=<?php echo $result['productId'] ?>" onclick="return confirm('Are you sure!');" >Xóa</a> 
					</td>	
				</tr>
				<?php
					}
