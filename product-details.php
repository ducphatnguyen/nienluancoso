                   ...
                   <div>
                        <div>
                            <a href="#">
                                ...
                                ?>
                                <img class="shadow-lg" src="admin/uploads/<?php echo $result_details['image']; ?>" alt="big-1" style="width: 100%">
                                <?php
                                        }
                                    }
                                ?>
                       ...
                       <form action="#" method="POST">
                            <div style="margin-left:13px">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <input class="form-control"  min="1" max="<?php echo $result_details['sl_conlai'] ?>" value="1" type="number" name="quantity">
                                    </div>
                                    <?php
                                        if(isset($Addtocart)) {
                                            echo $Addtocart;
                        ...
                        <div>
                            <form action="" method="POST">
                                ...
                                <?php
                                    if($customer_id) {
                                ?>
                                <input onclick="myFunction1()" class="btn btn-success" type="submit" name="binhluan_submit" value="Submit"></input>
                                <?php
                                    }else {
                                ?>
                ...
                <div class="row ">
                    ...
                    <div class="col-3 mb-5">
                        <div class="card" style="width: 16rem;">
                            <a href="product-details.php?proid=<?php echo $result_relation['productId']; ?>"><img style="width: 254px;height: 130px;" class="img-fluid" src="admin/uploads/<?php echo $result_relation['image']; ?>" alt="First place"></a>
                            <div class="card-body">
                                <h3><a class="text-decoration-none text-warning" href="#"><?php echo $result_relation['productName']; ?></a></h3>
                                <span class="current_price"><?php echo $fm->format_currency($result_relation['price']). " "."VND"; ?></span>
                                <?php
                                    if($result_relation['type'] == '1') {
                                ?>
                                <span class="text-decoration-line-through"><?php echo $fm->format_currency($result_relation['price']+$result_relation['price']*0.07). " "."VND"; ?></span>
                                <?php
                                    }
                                ?>   
                            </div>
